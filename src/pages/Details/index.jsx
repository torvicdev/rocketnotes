...
export function Details /*TODO COMPONENTE PRECISA COMEÇAR COM LETRA MAIÚSCULA */() {
  return (
    ...
    <Container>
      ...
      <main>
        {" "}
        {/*foi definido para deixar o header fixo em cima e 
      criar uma barra de rolagem só para o main*/}
        <Content>
          {/*foi definido para criar uma largura máxima de 550px para o 
        texto ficar dentro desse conteúdo*/}
          ...
          <Section title="Links úteis">
            <Links>
              <li>
                <a href="https://github.com/torvicdev">GitHub</a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/victor-silva-a4513924b/">
                  LinkedIn
                </a>
              </li>
            </Links>
